...
(function (factory) {
  ...
  var clearAnimationFrame = function () {
    return window.cancelAnimationFrame || window.webkitCancelAnimationFrame || window.mozCancelAnimationFrame || false;
  }();
  if (!setAnimationFrame) {
    ...
    if (!window.cancelAnimationFrame) clearAnimationFrame = function clearAnimationFrame(id) {};
  }
    ...
    this.lazyResize = function (tm) {
      ...
      */
      ...
      self.hlazyresize = setTimeout(function () {
        if (self) {
          self.resize();self.show();
        } // this form mandatory for uglify
      }, 240);
...
(function (root, factory) {
  ...
  function anime() {
    ...
    function syncInstanceChildren(time) {
      ...
      if (time >= instance.currentTime) {
        ...
        for (var _i = arrayLength(children); _i--;) {
  ...
  function timeline(params) {
    ...
    tl.add = function (instancesParams) {
      ...
      toArray(instancesParams).forEach(function (insParams) {
